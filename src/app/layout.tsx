...
export const metadata: Metadata = {
  ...
  description: "Request and manage a Telegram Mini App with games, tasks, Wallet tools and platform-controlled rewards.",
  applicationName: "Ads Galaxy",
  manifest: "/manifest.webmanifest",
  openGraph: { images: [{ url: "/og.png", width: 1200, height: 630, alt: "Launch Your Own Telegram Mini App with Ads Galaxy" }] },
